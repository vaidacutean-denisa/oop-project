...
void WeaponManager::initializeWeapons() {
	...
	weapons.push_back(std::make_unique<Weapon>("AK-47", 25.f, 2.5f, 30, 30, std::move(*ak_Ammo)));
	weapons.push_back(std::make_unique<Weapon>("Pistol", 18.f, 1.3f, 15, 15, std::move(*pistol_Ammo)));
	weapons.push_back(std::make_unique<Weapon>("M416", 23.5f, 1.8f, 30, 30, std::move(*m4_Ammo)));
